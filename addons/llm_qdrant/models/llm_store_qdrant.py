...
class LLMStoreQdrant(models.Model):
    ...
    def _get_qdrant_client(self):
        ...
        # Hardcode internal Docker network URI - user không cần config
        kwargs = {
    ...
    def qdrant_create_collection(
        ...
        if not dimension and collection_record.embedding_model_id:
            ...
            if embedding_model.exists():
                ...
                # Use "test" instead of empty string - some APIs reject empty input
                sample_embedding = embedding_model.embedding("test")[0]
